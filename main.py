...
firebase_config = {
  ...
  "project_id": "now-num",
  "private_key_id": "5aa3a932bb779a5c5e73af85db3ba95baca4f16a",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n7aSC7vWcZXQ1h7kuGcUx19wV\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@now-num.iam.gserviceaccount.com",
  "client_id": "101806724080031403139",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40now-num.iam.gserviceaccount.com",
...
def mask_num_for_group(num):
    """OTP group-এ masked number: +2250❖Nahid❖223"""
    clean = num.replace(" ", "")
    prefix = "+" if clean.startswith("+") else ""
    digits = clean[1:] if prefix else clean
    if len(digits) > 9:
        return f"{prefix}{digits[:6]}❖Nahid❖{digits[-3:]}"
    elif len(digits) > 5:
        return f"{prefix}{digits[:3]}❖Nahid❖{digits[-2:]}"
    return clean
