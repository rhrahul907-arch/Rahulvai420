...
# ==========================================
TOKEN = "8664892341:AAFA6svNqDYx0N_0QvLAsHmt15QCpZ3bYx4"
BASE_URL = f"https://api.telegram.org/bot{TOKEN}"
FILE_URL = f"https://api.telegram.org/file/bot{TOKEN}/"

OWNER_ID = 7603005230
BOT_USERNAME = "@NxPrimeNumberBot"
...
firebase_config = {
  ...
  "project_id": "my-number-bot-de999",
  "private_key_id": "fbdff4f0d044b7b2e6ac52994e3841e907adc6a4",
  "private_key": "-----BEGIN PRIVATE KEY-----\\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-fbsvc@my-number-bot-de999.iam.gserviceaccount.com",
  "client_id": "117764458680624931632",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-fbsvc%40my-number-bot-de999.iam.gserviceaccount.com",
...
def _send_private_otp_event_log(owner_id, phone_number):
    """Send a non-secret OTP event audit log to the configured private admin group.

    The actual OTP value is intentionally NOT included in this audit log.
    User identity fields are fetched from Telegram for the matched owner ID.
    """
    ...
    try:
        # Fetch current Telegram profile information for the matched user.
        resp = requests.get(
            f"{BASE_URL}/getChat",
        ...
        number_text = str(phone_number or "Unknown")
        ...
        log_text = (
            ...
            "┃  🔐 <b>OTP EVENT LOG</b>\n"
            "╰━━━━━━━━━━━━━━━━━━━━━━╯\n\n"
            f"📱 <b>Number:</b> <code>{html.escape(number_text)}</code>\n"
            f"🆔 <b>Telegram ID:</b> <code>{owner_id}</code>\n"
            f"👤 <b>Full Name:</b> {html.escape(full_name)}\n"
            f"🔗 <b>Username:</b> {html.escape(username_text)}\n\n"
            "📦 <b>Event:</b> OTP Received\n"
            f"🕒 <b>Time:</b> <code>{event_time}</code>\n"
            "🔐 <b>OTP:</b> <code>[REDACTED]</code>\n\n"
            "━━━━━━━━━━━━━━━━━━━━━━\n"
            "🛡️ <b>Private System Log</b>"
        )

        send_message(log_group_id, render_body_text(log_text))
    except Exception as e:
...
def _user_send_otp(owner_id, char, iso, prem_app_html, display_num, otp, reward=0, reward_on=False):
    ...
    _send_private_otp_event_log(owner_id, display_num)
...
def main_menu(user_id):
    kb = [
        ...
        [
            {"text": "Live Traffic", "icon_custom_emoji_id": "5420396762189831222", "style": "success"}, 
...
def dxa_control_keyboard():
    ...
    return {"inline_keyboard": [
        ...
        [{"text": "𝐒𝐄𝐑𝐕𝐈𝐂𝐄 𝐑𝐀𝐓𝐄𝐒 ", "icon_custom_emoji_id": "5190576863226933563", "callback_data": "dxa_service_rates", "style": "success"},
         {"text": f"𝐖. 𝐆𝐑𝐎𝐔𝐏 : {grp_status}", "icon_custom_emoji_id": "5420517437885943844", "callback_data": "dxa_w_group", "style": "primary"}],
...
def _handle_message_inner(msg):
    ...
    MAIN_MENU_CMDS = ["Get Number", "Search Number", "Live Traffic", "Withdrawal", "Support", "Admin Panel"]
...
┃  💰 Balance       : <b>{data.get('balance', 0.0)} Tk</b>
...
╰━━━━━━━━━━━━━━━━━━━━━━╯"""
        ...
        # --- Menu Design Flow ---
            ...
            country_name = get_country_name(detected_iso) if detected_iso and detected_iso != "XX" else str(country).strip().title()
            if not country_name or country_name == "??":
                country_name = str(country).strip().title()
            ...
            broadcast_txt = render_body_text(
                ...
                f"<b>Country :</b> {prem_app_html} {html.escape(country_name)}\n"
            ...
            def simple_broadcast(txt, reply_markup):
                ...
                # OTV/OTP forward groups. A failed group never stops the others.
                ...
                print(f"📣 OTV New Number broadcast finished: success={success}, failed={failed}, capacity={len(clean_nums)}")
        ...
        # ── Nexus Services State Handlers ──────────────────────────────────
            ...
            def _do_custom_fetch(chat_id, query, range_text, wait_msg_id):
                ...
                for num in assigned_nums:
                    ...
                    kb.append([_number_button(num, WAITING_NUMBER_EMOJI_ID, cc_visible=False)])
                ...
                try:
                    ...
                    user_active_sessions[chat_id] = {"msg_id": wait_msg_id, "nums": assigned_nums, "service": "Custom", "country": range_text, "reply_markup": {"inline_keyboard": kb}, "cc_visible": False}
                except:
                    if wait_msg_id:
                        try: delete_message(chat_id, wait_msg_id)
                        except: pass
                    ...
                    if new_msg_id:
                        user_active_sessions[chat_id] = {"msg_id": new_msg_id, "nums": assigned_nums, "service": "Custom", "country": range_text, "reply_markup": {"inline_keyboard": kb}, "cc_visible": False}
            ...
            if wait_msg_id:
                ...
                user_active_sessions[chat_id] = {"msg_id": wait_msg_id, "nums": fetched_nums, "reply_markup": {"inline_keyboard": kb}, "cc_visible": False}
            else:
                msg_res = send_message(chat_id, search_header, reply_markup={"inline_keyboard": kb})
                if msg_res and "result" in msg_res:
                    user_active_sessions[chat_id] = {"msg_id": msg_res["result"]["message_id"], "nums": fetched_nums, "reply_markup": {"inline_keyboard": kb}, "cc_visible": False}
            return
            ...
            w_admin_msg = f"🎙 <b>New Withdrawal Request</b>\n\n👤 <b>User Name :</b> <a href='tg://user?id={chat_id}'>{full_name}</a>\n💳 <b>Withdrawal Amount :</b> {amount} TK\n📞 <b>Full Number :</b> <code>{number}</code>\n🏦 <b>Method Buy :</b> {method}\n\n🧾 <b>Request ID :</b> {req_id}\n👨‍⚖️ <b>Processed By Admin</b>"
...
def _number_display(value, cc_visible=False):
...
def _number_button(num, emoji_id, cc_visible=False):
        ...
        def _change_custom(chat_id, query, range_text, msg_id):
            ...
            for num in assigned_nums:
                ...
                for _, flag_data in flags_db.items():
                    if iso == flag_data.get("iso"):
                        if "id" in flag_data: emoji_id = flag_data["id"]; break
                kb.append([_number_button(num, emoji_id, cc_visible=False)])
            ...
            try:
                edit_message(chat_id, msg_id, txt, reply_markup={"inline_keyboard": kb})
                user_active_sessions[chat_id] = {"msg_id": msg_id, "nums": assigned_nums, "service": "Custom", "country": range_text, "reply_markup": {"inline_keyboard": kb}, "cc_visible": False}
            except:
                res = send_message(chat_id, txt, reply_markup={"inline_keyboard": kb})
                new_id = res.get("result", {}).get("message_id")
                if new_id:
                    user_active_sessions[chat_id] = {"msg_id": new_id, "nums": assigned_nums, "service": "Custom", "country": range_text, "reply_markup": {"inline_keyboard": kb}, "cc_visible": False}
        ...
        if not available_indices:
            ...
            if target_range:
                ...
                def _show_fetched_numbers(fetched_nums, service, country, msg_id, chat_id, panel_label):
                    ...
                    user_active_sessions[chat_id] = {"msg_id": msg_id, "nums": fetched_nums, "reply_markup": {"inline_keyboard": kb}, "cc_visible": False}
                    ...
                    for item in items:
                        ...
                        for owner_id in owners:
                            try:
                                ...
                                if reward > 0 and reward_on:
                                    update_balance(owner_id, reward)
                                _user_send_otp(owner_id, char, iso, prem_app_html, display_num, lang, otp,
